                ...
                if (diff == 0)
                {
                    ...
                    if (Interlocked.CompareExchange(ref _headAndTail.Head, currentHead + 1, currentHead) == currentHead)
                    {
                        ...
                        if (Thread.VolatileRead(ref _preservedForObservation) == 0)
                        {
                            ...
                            // celebrations, peeking, ToArray, etc.  And we don't update the sequence number,
...
// ============================================================================
// STUBS AND INTERNAL COMPATIBILITY LAYER
// ============================================================================
...
/// Backward-compat stub for older targets lacking modern nullability attributes.
/// </summary>
